...
一个基于 Go-Zero 框架构建的多功能区块链钱包 API 服务，集成了 LI.FI 跨链协议，提供完整的钱包操作、代币交换、跨链转账和授权管理功能。
...
| 链名称 | Chain ID | 主网/测试网 | RPC 状态 |
|--------|----------|-------------|----------|
| BSC | 56 | 主网 | ✅ 已配置 |
| Ethereum | 1 | 主网 | ⚠️ 需配置 |
| Polygon | 137 | 主网 | ⚠️ 需配置 |
| Arbitrum | 42161 | 主网 | ⚠️ 需配置 |
| Optimism | 10 | 主网 | ⚠️ 需配置 |
| Base | 8453 | 主网 | ⚠️ 需配置 |
